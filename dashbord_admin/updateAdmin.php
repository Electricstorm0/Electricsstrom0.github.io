...
$id = $_GET['Id_admin'];
$select_admin = query("SELECT * FROM admin WHERE Id_admin = $id")[0];
...
if (isset($_POST['submit'])) {
    function update($data)
    {
        ...
        $sql = "UPDATE admin SET nama = '$name', email = '$email', password = '$cpass' WHERE Id_admin = $id";
...
<body style="background-color:antiquewhite ;">
    ...
    <div class="container mt-5 bg-white shadow-sm p-4">
        ...
        <form action="" method="post">
            ...
            <input type="hidden" name="Id_admin" value="<?= $select_admin["Id_admin"]; ?>">
            <div class="mb-3">
                <input type="text" name="name" placeholder="Enter your name" required
                    value="<?= $select_admin["nama"]; ?>" class="form-control">
            </div>
            <div class="mb-3">
                <input type="email" name="email" placeholder="Enter your email" required
                    value="<?= $select_admin["email"]; ?>" class="form-control">
            </div>
            <div class="mb-3">
                <input type="password" name="password" placeholder="Enter your password" required
                    value="<?= $select_admin["password"]; ?>" class="form-control">
            </div>
            <div class="mb-3">
